...
public class Video_view_herramientas_digitales extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
        setContentView(R.layout.activity_video_view_herramientas_digitales);
        setUpVideoView();
    }
    ...
    private void setUpVideoView() {
        String youtubeVideoId = "uQMQqh-wMqM";
